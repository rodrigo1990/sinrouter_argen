			...
			<div class="col-lg-12 col-sm-12 panel">
				...
				<div class="row margin">
						<div class="form-group text-center">
							...
							<input type="text" name="usuario" id="usuario" class="form-control text-center" placeholder="info@argenpesos.com.ar">
						</div>
						<div class="form-group text-center">
	...
	function validarUsuario(){
		...
		var pass=$("#pass").val();
			...
			$.ajax({
				...
				url:'admin/ajax/validarUsuario.php',
				type:'post',
				success:function(response){

					if(response=='TRUE'){
						window.location ="admin/home.php?email="+email+"";
					}else{

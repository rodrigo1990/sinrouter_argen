            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen1Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen1Actual($_GET['ID']) ?>);"></div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen2Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen2Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen3Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen3Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen4Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen4Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen5Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen5Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen6Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen6Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen7Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen7Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen8Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen8Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen9Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen9Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>
            ...
            <div class="actual-img-cont">
                  <span class="center-block">
                    <h3>IMAGEN ACTUAL:</h3><?php $nov->imagen10Actual($_GET['ID']) ?>
                                ...
                                <div class="center-block img-actual" style="background-image:url(../../storage/img/club_argenpesos/<?php  $nov->imagen10Actual($_GET['ID']) ?>);"></div>
            </div>
        </div>

...
class Novedad{
	...
	public function listarNovedadesUser(){
		...
		while($fila=mysqli_fetch_assoc($consulta)){
		  ...
		  echo '<div class="resp-soc-row row  padding-top-50 padding-bottom-50 bk-grey ">
				    <div class="container">
				      <div class="col-lg-6 col-sm-6">
				        <h2 class="titulos red">'.strtoupper(utf8_encode($fila['titulo'])).'</h2>
				        <h3 class="subtitulos red"><i>'.utf8_encode($fila['subtitulo']).'</i></h3>
				        <br>
				        ...
				        <div class="col-lg-6 col-sm-6 img-section">
				          <div class="overlay">
				            ...
				            <a class="content" data-fancybox="gallery'.$i.'" href="/storage/img/club_argenpesos/'.$fila["img1"].'" data-caption="'.utf8_encode($fila["descripcion"]).'" >
				          ...
				          <div class="img-portada" style="background-image:url(/storage/img/club_argenpesos/'.$fila["img1"].');"></div>
		...
		if($fila["img2"]!=""){
			...
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img2']."' data-caption='".utf8_encode($fila['descripcion'])."'>
								</a>";

		}

		if($fila["img3"]!=""){
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img3']."' data-caption='".utf8_encode($fila['descripcion'])."' >
								</a>";
		}

		if($fila["img4"]!=""){
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img4']."' data-caption='".utf8_encode($fila['descripcion'])."'>
								</a>";
		}

		if($fila["img5"]!=""){
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img5']."' data-caption='".utf8_encode($fila['descripcion'])."'>
								</a>";
		}

		if($fila["img6"]!=""){
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img6']."' data-caption='".utf8_encode($fila['descripcion'])."'>
								</a>";
		}

		if($fila["img7"]!=""){
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img7']."' data-caption='".utf8_encode($fila['descripcion'])."'>
								</a>";
		}

		if($fila["img8"]!=""){
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img8']."' data-caption='".utf8_encode($fila['descripcion'])."'>
								</a>";
		}

		if($fila["img9"]!=""){
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img9']."' data-caption='".utf8_encode($fila['descripcion'])."'>
								</a>";
		}

		if($fila["img10"]!=""){
			echo "<a  style='display:none'data-fancybox='gallery".$i."' href='/storage/img/club_argenpesos/".$fila['img10']."' data-caption='".utf8_encode($fila['descripcion'])."'>
								</a>";
		}
		...
		echo "</div>";
           	 ...
           	 echo '<div class="resp-soc-row  row   padding-top-50 padding-bottom-50">
				    <div class="container">
				      <div class="col-lg-6 col-lg-push-6 col-sm-6">
				        <h2 class="titulos red ">'.strtoupper(utf8_encode($fila['titulo'])).'</h2>
				        <h3 class="subtitulos red"><i>'.utf8_encode($fila['subtitulo']).'</i></h3>
				        <br>
				        <p>'.utf8_encode($fila['descripcion']).'</p>
		...
		echo "</div>";
			 ...
			 if($i==0){
		        echo  '<div class="container">
                          <div class="row">
                            <div class="col-sm-12 text-center" style="padding: 90px 0px;">
                              <img src="imagenes/conos.png" alt="" /><br />
                              <h1 class="titulos" style="padding: 15px 0px 0px 0px; margin: 0px;text-align:center">PRÓXIMAMENTE RESPONSABILIDAD SOCIAL</h1>
                              <!--<h2 class="subtitulo_club">Todas nuestras acciones de responsabilidad social</h2>-->
                            </div>
                          </div>
                        </div>
	...
	public function insertarNovedad($titulo,$subtitulo,$descripcion,$imagen1,$imagen2,$imagen3,$imagen4,$imagen5,
		...
		try{
			...
			try{
				...
				//carga imagenes Big
				$target_path="..//storage/img/club_argenpesos/";
	...
	public function actualizarNovedad($id,$titulo,$subtitulo,$descripcion,$imagen1,$imagen2,$imagen3,$imagen4,$imagen5,$imagen6,$imagen7,$imagen8,$imagen9,$imagen10){
		...
		try{
				...
				if($imagen1!=''){
					...
					unlink("..//storage/img/club_argenpesos/".$fila['img1']."");
				...
				if($imagen2!=''){
					...
					//Elimino el archivo fisico
					unlink("..//storage/img/club_argenpesos/".$fila['img2']."");
				...
				if($imagen3!=''){
					...
					if($fila['img3']!=""){
						...
						//Elimino el archivo fisico
						unlink("..//storage/img/club_argenpesos/".$fila['img3']."");
				...
				if($imagen4!=''){
					...
					//Elimino el archivo fisico
					unlink("..//storage/img/club_argenpesos/".$fila['img4']."");
				...
				if($imagen5!=''){
					...
					if($fila['img5']!=""){
					//Elimino el archivo fisico
					unlink("..//storage/img/club_argenpesos/".$fila['img5']."");
					}
				...
				if($imagen6!=''){
					...
					if($fila['img6']!=""){
					//Elimino el archivo fisico
					unlink("..//storage/img/club_argenpesos/".$fila['img6']."");
				...
				if($imagen7!=''){
					...
					if($fila['img7']!=""){
					//Elimino el archivo fisico
					unlink("..//storage/img/club_argenpesos/".$fila['img7']."");
					}
				...
				if($imagen8!=''){
					...
					if($fila['img8']!=""){
					//Elimino el archivo fisico
					unlink("..//storage/img/club_argenpesos/".$fila['img8']."");
					}
				...
				if($imagen9!=''){
					...
					if($fila['img9']!=""){
					//Elimino el archivo fisico
					unlink("..//storage/img/club_argenpesos/".$fila['img9']."");
					}
				...
				if($imagen10!=''){
					...
					if($fila['img10']!=""){
					//Elimino el archivo fisico
					unlink("..//storage/img/club_argenpesos/".$fila['img10']."");
					}

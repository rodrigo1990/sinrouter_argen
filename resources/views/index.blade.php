...
<section id="shop" class="margin-top-60 padding-bottom-47">
	<div class="container">
				...
				<div class="owl-one owl-carousel owl-theme slider" id="shop-slider">
							<div>
								<div class="producto">
									<img class="center-block" src="<?php echo asset('storage/img/shop/productos/p-02.png') ?>" alt="">
									<div class="text-center">
										<h3 class="violet"><b>XIAOMI</b> Redemi 5</h3>
										
										<h4>Hasta <b>18 CUOTAS SIN INTERÉS</b> de</h4>
										
										<h4 class="precio blue"><b>$599</b></h4>


									</div>
									<hr>

									<p class="precio-lista">*Precio de lista $10.799</p>
									
									<a data-toggle="modal" data-target="#1" class="spa-btn border-btn violet center-block margin-top-25 text-center" target="">VER MÁS</a>
							...
							<div>
								<div class="producto">
									<img class="center-block" src="<?php echo asset('storage/img/shop/productos/p-03.png') ?>" alt="">
									<div class="text-center">
										<h3 class="violet"><b>NOKIA</b> 5.1 Plus</h3>
										
										<h4>Hasta <b>18 CUOTAS SIN INTERÉS</b> de</h4>
										
										<h4 class="precio blue"><b>$999</b></h4>
									</div>
									<hr>

									<p class="precio-lista">*Precio de lista $17.999</p>
									
									<a data-toggle="modal" data-target="#2" class="spa-btn border-btn violet center-block margin-top-25 text-center" target="">VER MÁS</a>
							...
							<div>
								<div class="producto">
									<img class="center-block" src="<?php echo asset('storage/img/shop/productos/p-04.png') ?>" alt="">
									<div class="text-center">
										<h3 class="violet"><b>NOKIA</b> 1 Plus</h3>
									...
									<p class="precio-lista">*Precio de lista $10.999</p>
									
									<a data-toggle="modal" data-target="#3" class="spa-btn border-btn violet center-block margin-top-25 text-center" target="">VER MÁS</a>
							...
							<div>
								<div class="producto">
									<img class="center-block" src="<?php echo asset('storage/img/shop/productos/p-05.png') ?>" alt="">
									<div class="text-center">
										<h3 class="violet"><b>NOKIA</b> 106</h3>
										
										<h4>Hasta <b>18 CUOTAS SIN INTERÉS</b> de</h4>
										
										<h4 class="precio blue"><b>$186</b></h4>
									</div>
									<hr>

									<p class="precio-lista">*Precio de lista $3.359</p>
									
									<a data-toggle="modal" data-target="#4" class="spa-btn border-btn violet center-block margin-top-25 text-center" target="">VER MÁS</a>
							...
							<div>
								<div class="producto">
									<img class="center-block" src="<?php echo asset('storage/img/shop/productos/p-06.png') ?>" alt="">
									<div class="text-center">
										<h3 class="violet"><b>VLAK</b> Alpha</h3>
									...
									<p class="precio-lista">*Precio de lista $3.839</p>
									
									<a data-toggle="modal" data-target="#5" class="spa-btn border-btn violet center-block margin-top-25 text-center" target="">VER MÁS</a>

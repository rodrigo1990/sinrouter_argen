...
<body>
	<table style='color: #1da3dd; font-size: 17px; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>
		...
		<tr><td style='text-transform:uppercase;'><br />¡ESTIMADO/A {{$consulta->nombre}} {{$consulta->apellido}} TU CREDITO ESTA SIENDO ANALIZADO!<br />EN BREVE NOS CONTACTAREMOS CON VOS<br /><br /></td></tr>

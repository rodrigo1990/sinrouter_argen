<section id="contacto" class=" text-center padding-60 {{$class}}">
	...
	<ul class="flex center-block margin-top-25">
		...
		<li>
			...
			<a href="https://api.whatsapp.com/send?phone=541132414878&text=Hola!%20les%20consulto%20por%20los%20servicios%20vistos%20en%20www.argenpesos.com.ar" target="_blank" style="{{$color}}">
				<img src="<?php echo asset("storage/img/con-icon-3.png")?>" alt="">
				<h4><b>WHATSAPP</b> <br> 011-3241-4878</h4>
			</a>
		</li>
		<li>
			<a href="https://www.facebook.com/argenpesos" target="_blank" style="{{$color}}">
				<img src="<?php echo asset("storage/img/con-icon-4.png")?>" alt="">
				<h4><b>FACEBOOK</b> <br> /argenpesos</h4>
			</a>
		</li>
		<li>
			<a href="https://www.instagram.com/argenpesos/" target="_blank" style="{{$color}}">

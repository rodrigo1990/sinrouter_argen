...
<div class="bk-landing flex-align-vert" style="height: 100vh !important;">
	<a href="index">
		<img class="logo"  src="<?php echo asset('storage/img/logo-white-bg.png') ?>" alt="">
	</a>
        <div class="row flex-align-vert child">
	        ...
	        <a href="index" class="center-block text-center big border-btn red margin-top-50">VOLVER</a>
        </div>
</div>

<div class="container">
				...
				<div class="owl-one owl-carousel owl-theme slider" id="shop-slider">
							...
							<div>
								@component('comp.producto')
									...
									@endslot
									@slot('img')
								    	storage/img/shop/productos/p-03.png
									@endslot
									@slot('dataTarget')
								    	#3
									@endslot		
							...
							<div>
								@component('comp.producto')
									...
									@endslot
									@slot('img')
								    	storage/img/shop/productos/p-04.png
									@endslot
									@slot('dataTarget')
								    	#4
									@endslot		
							...
							<div>
								@component('comp.producto')
									...
									@endslot
									@slot('img')
								    	storage/img/shop/productos/p-05.png
									@endslot
									@slot('dataTarget')
								    	#5
									@endslot		
							...
							<div>
								@component('comp.producto')
									...
									@endslot
									@slot('img')
								    	storage/img/shop/productos/p-06.png
									@endslot
									@slot('dataTarget')
								    	#6
									@endslot		
			...
			<div class="center-block" style="">
				...
				<a  data-toggle="modal" data-target="#helpShop"class="spa-btn border-btn gray text-center  margin-top-40 float-left" target="">TE AYUDAMOS A COMPRAR</a>
